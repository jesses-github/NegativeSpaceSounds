...
source_file = os.listdir(source_folder)[0]
...
mail_service.send_email(recipients=client_email, subject=file_name, body=create_email_string(client_name, file_url, file_name, additional_points='Testing string'))